...
class WanTransformer3DModel(
    ...
    def pre_forward(
        ...
        shape_config = (batch_size, post_patch_num_frames, post_patch_height, post_patch_width, p_t, p_h, p_w)
        ...
        return hidden_states, timestep_proj, encoder_hidden_states, rotary_emb, temb, shape_config, lora_scale
    ...
    def block_forward(
        ...
        timestep_proj:  torch.FloatTensor,
        rotary_emb,
    ):
    ...
    def post_forward(
        ...
        batch_size, post_patch_num_frames, post_patch_height, post_patch_width, p_t, p_h, p_w = shape_config
