...
class WanRotaryPosEmbed_audio(nn.Module):
    def __init__(
        self,
        attention_head_dim: int,
        patch_size: Tuple[int, int, int],
        ...
        w_dim = h_dim = 2
        t_dim = (attention_head_dim - w_dim - h_dim)
...
class WanTransformer3DModel(
    ...
    def __init__(
        ...
        self.rope = WanRotaryPosEmbed_audio(attention_head_dim, patch_size, rope_max_seq_len)
    ...
    def forward(
        ...
        ### TODO: Check
        hidden_states = self.patch_embedding(hidden_states)        # [B, C, T, H, W] -> [B, inner_dim, T//p_t, H//p_h, W//p_w]
        hidden_states = hidden_states.flatten(2).transpose(1, 2)   # [B, (T//p_t * H//p_h * W//p_w), inner_dim]
