...
from model.ovi.fusion import FusionModel
from model.ovi.t5 import T5EncoderModel
from model.ovi.vae2_2 import Wan2_2_VAE
from model.ovi.mmaudio.features_utils import FeaturesUtils
...
def init_fusion_score_model_ovi(rank: int = 0, meta_init=False):
    video_config = "utils/ovi_configs/model/dit/video.json"
    audio_config = "utils/ovi_configs/model/dit/audio.json"
